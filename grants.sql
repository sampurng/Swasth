...
EXCEPTION
    WHEN E_ROLES_ABSENT THEN
            ...
            DBMS_OUTPUT.PUT_LINE('SWASTH_ADMIN ROLE GIVEN ACCESS, CREATING sadmin USER WITH ROLE SWATH_ADMIN');
            ...
            EXECUTE IMMEDIATE 'GRANT CREATE SESSION TO SWASTH_EVENT_MANAGER';
            EXECUTE IMMEDIATE 'GRANT CONNECT TO SWASTH_EVENT_MANAGER';
